#ifndef _ROS_scbdriver_PositionGuideVision_h
#define _ROS_scbdriver_PositionGuideVision_h
...
namespace scbdriver
{
  ...
  class PositionGuideVision : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "scbdriver/PositionGuideVision"; };
