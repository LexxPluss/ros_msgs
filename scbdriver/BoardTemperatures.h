#ifndef _ROS_scbdriver_BoardTemperatures_h
#define _ROS_scbdriver_BoardTemperatures_h
...
namespace scbdriver
{
  ...
  class BoardTemperatures : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "scbdriver/BoardTemperatures"; };
