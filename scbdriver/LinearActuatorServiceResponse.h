#ifndef _ROS_scbdriver_LinearActuatorServiceResponse_h
#define _ROS_scbdriver_LinearActuatorServiceResponse_h
...
namespace scbdriver
{
  ...
  class LinearActuatorServiceResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "scbdriver/LinearActuatorServiceResponse"; };
