#ifndef _ROS_lexxauto_msgs_GoalPoseListMessage_h
#define _ROS_lexxauto_msgs_GoalPoseListMessage_h
...
namespace lexxauto_msgs
{
  ...
  class GoalPoseListMessage : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "lexxauto_msgs/GoalPoseListMessage"; };
