#ifndef _ROS_lexxauto_msgs_WheelVelocity_h
#define _ROS_lexxauto_msgs_WheelVelocity_h
...
namespace lexxauto_msgs
{
  ...
  class WheelVelocity : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "lexxauto_msgs/WheelVelocity"; };
