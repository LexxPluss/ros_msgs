#ifndef _ROS_lexxauto_msgs_MapAreaAttribute_h
#define _ROS_lexxauto_msgs_MapAreaAttribute_h
...
namespace lexxauto_msgs
{
  ...
  class MapAreaAttribute : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "lexxauto_msgs/MapAreaAttribute"; };
