#ifndef _ROS_lexxauto_msgs_ExecutionScene_h
#define _ROS_lexxauto_msgs_ExecutionScene_h
...
namespace lexxauto_msgs
{
  ...
  class ExecutionScene : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "lexxauto_msgs/ExecutionScene"; };
