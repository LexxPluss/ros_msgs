#ifndef _ROS_lexxauto_msgs_AgvLineOffset_h
#define _ROS_lexxauto_msgs_AgvLineOffset_h
...
namespace lexxauto_msgs
{
  ...
  class AgvLineOffset : public ros::Msg
  {
    public:
      uint32_t id_length;
    ...
    virtual const char * getType() override { return "lexxauto_msgs/AgvLineOffset"; };
